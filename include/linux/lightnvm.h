...
typedef int (nvm_tgt_prep_rq)(struct request *, void *);
typedef void (nvm_tgt_unprep_rq)(struct request *, void *);
...
extern int nvm_register(struct gendisk *, struct nvm_dev_ops *);
extern void nvm_unregister(struct gendisk *);
extern int nvm_prep_rq(struct request *rq);
extern void nvm_unprep_rq(struct request *rq);
...
static inline int nvm_register(struct gendisk *disk, struct nvm_dev_ops *ops)
{
	return -EINVAL;
}
static inline void nvm_unregister(struct gendisk *) {}
static inline int nvm_prep_rq(struct request *rq)
{
	return -EINVAL;
}
static inline void nvm_unprep_rq(struct request *rq) {}
